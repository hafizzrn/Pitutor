  ...
  return (
    <section className="relative py-8 md:py-16">
      ...
      <div className="flex justify-center items-center h-full">
        <div className="mt-24 md:max-w-[660px] text-center flex flex-col items-center gap-6">
          <h1 className="text-[24px] md:text-[50px] text-center font-semibold">
            Pecahkan Masalahmu,
            <br /> Tingkatkan Prestasimu
          </h1>
          <p className="text-[#00000066] text-base md:text-xl">
