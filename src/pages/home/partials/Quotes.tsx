...
const Quotes = () => {
  return (
    <section className="bg-primary ">
      <div className="container py-10 md:py-20 flex flex-col xl:flex-row gap-8 md:gap-16 justify-center text-white">
        <div className="flex gap-2 md:gap-5 items-start">
          <img src={quoteImage} alt="" />
          <h1 className="text-[24px] md:text-[50px] font-semibold text-white ">
            Pembelajaran
            <br /> Online yang
            <br /> Dipersonalisasi
          </h1>
        ...
        <div className="flex flex-col gap-10">
          <p className="text-base md:text-xl xl:max-w-[680px] text-justify">
